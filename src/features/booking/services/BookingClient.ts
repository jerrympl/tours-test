...
export class BookingClient {
  async getAvailableProducts(): Promise<{ data: ProductsResponse }> {
              ...
              items: [
                {
                  ...
                  media: {
                    small: {
                      url:
                        'https://webdev-exercise.netlify.com/assets/carousel-1.png',
                      width: 285,
                      height: 171,
                    },
                  },
                ...
                },
                {
                  ...
                  media: {
                    small: {
                      url:
                        'https://webdev-exercise.netlify.com/assets/carousel-2.png',
                      width: 285,
                      height: 171,
                    },
                  },
                ...
                },
                {
                  ...
                  media: {
                    small: {
                      url:
                        'https://webdev-exercise.netlify.com/assets/carousel-3.png',
                      width: 285,
                      height: 171,
                    },
                  },
                ...
                },
                {
                  ...
                  media: {
                    small: {
                      url:
                        'https://webdev-exercise.netlify.com/assets/carousel-4.png',
                      width: 285,
                      height: 171,
                    },
                  },
